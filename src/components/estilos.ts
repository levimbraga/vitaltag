...
const BASE_LINK_BOTAO =
  "inline-flex items-center justify-center border px-4 text-center transition-colors outline-none select-none focus-visible:ring-3 focus-visible:ring-ring/50";
